...
export class MockData {
  public static Dishes: Dish[] = [
    ...
    },
    {
      ...
      description:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse quis sollicitudin lectus, ac lobortis felis. Duis leo nulla, convallis nec malesuada ac, tristique et ex. Sed nec odio et mauris semper tristique. Aliquam suscipit eleifend arcu. Etiam quis sodales orci. Cras auctor nec ligula ac hendrerit. Donec placerat hendrerit lorem, in tincidunt massa tristique a. In lectus nisl, mattis eu vestibulum ac, tristique nec eros.',
      url: 'https://www.oetker.pl/Recipe/Recipes/oetker.pl/pl-pl/miscellaneous/image-thumb__51050__RecipeDetail/pizza-domowa.jpg',
      avgStars: 4.5,
    },
    {
      dishID: 2,
    ...
    },
    {
      ...
      description:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse quis sollicitudin lectus, ac lobortis felis. Duis leo nulla, convallis nec malesuada ac, tristique et ex. Sed nec odio et mauris semper tristique. Aliquam suscipit eleifend arcu. Etiam quis sodales orci. Cras auctor nec ligula ac hendrerit. Donec placerat hendrerit lorem, in tincidunt massa tristique a. In lectus nisl, mattis eu vestibulum ac, tristique nec eros.',
      url: 'https://s3.przepisy.pl/przepisy3ii/img/variants/800x0/zupa-pomidorowa.jpg',
      avgStars: 4,
    },
    {
      dishID: 4,
    ...
    },
    {
      ...
      description:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse quis sollicitudin lectus, ac lobortis felis. Duis leo nulla, convallis nec malesuada ac, tristique et ex. Sed nec odio et mauris semper tristique. Aliquam suscipit eleifend arcu. Etiam quis sodales orci. Cras auctor nec ligula ac hendrerit. Donec placerat hendrerit lorem, in tincidunt massa tristique a. In lectus nisl, mattis eu vestibulum ac, tristique nec eros.',
      url: 'https://www.przyslijprzepis.pl/media/cache/default_view/uploads/media/recipe/0006/63/a5e4bf0843b7fd8bb2738e3b2477771a33f62c4b.jpeg',
      avgStars: 5,
    },
    {
      dishID: 11,
      ...
      description:
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse quis sollicitudin lectus, ac lobortis felis. Duis leo nulla, convallis nec malesuada ac, tristique et ex. Sed nec odio et mauris semper tristique. Aliquam suscipit eleifend arcu. Etiam quis sodales orci. Cras auctor nec ligula ac hendrerit. Donec placerat hendrerit lorem, in tincidunt massa tristique a. In lectus nisl, mattis eu vestibulum ac, tristique nec eros.',
      url: 'https://d3iamf8ydd24h9.cloudfront.net/pictures/articles/2017/04/10017-v-900x556.jpg',
      avgStars: 3.5,
    },
  ];
}
